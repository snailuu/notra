...
function handleGovernanceSession(request, response, governanceToken) {
...
async function handleGovernanceReject(request, response, projectRoot, governanceToken) {
...
function isInsideDirectory(rootDirectory, candidatePath) {
