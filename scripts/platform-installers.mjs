...
const SUPPORTED_PLATFORMS = ["claude", "codex", "agents"];

const PLATFORM_SKILL_DIRECTORIES = {
...
async function ensureSourcePlugin(sourcePluginRoot) {
...
async function copyTree(options) {
...
async function copyFile({
  ...
  const existing = await fs.readFile(targetPath, "utf8").catch((error) => {
...
function transformSkillFile(content, sourcePath) {
